...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
    ...
    return (
        <section className='relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
            <span className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-white via-white/90 to-white/40 bg-clip-text text-center text-7xl font-bold leading-none text-transparent'>
                {text}
            </span>
    ...
    return (
        <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
                ...
                <>
                    ...
                    <BoxReveal boxColor='var(--skeleton)' duration={0.3} width='100%'>
                        <section className='flex items-center gap-4'>
                            <hr className='flex-1 border-1 border-dashed border-white/20' />
            ...
            <form onSubmit={handleSubmit}>
                ...
                >
                    <button
                        className='relative group/btn bg-accent/80 backdrop-blur-md border border-accent/30 w-full text-white
                        rounded-full h-12 font-medium shadow-lg shadow-accent/20 outline-hidden hover:cursor-pointer
                        hover:bg-accent hover:shadow-xl hover:shadow-accent/30 transition-all duration-300'
                        type='submit'
                    >
                        {submitButton} &rarr;
                        <BottomGradient />
                ...
                {textVariantButton && goTo && (
                    <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
                        <section className='mt-4 text-center hover:cursor-pointer'>
                            <button
                                className='text-sm text-accent hover:text-accent-light hover:cursor-pointer outline-hidden transition-colors'
                                onClick={goTo}
                            >
                                {textVariantButton}
                            </button>
