...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, #0d2b26cc 0%, #2D8B7A44 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(45, 139, 122, 0.5)',
      ...
      '--sunpillar-1': 'hsl(168, 53%, 40%)',
      '--sunpillar-2': 'hsl(175, 60%, 50%)',
      '--sunpillar-3': 'hsl(160, 70%, 45%)',
      '--sunpillar-4': 'hsl(180, 50%, 55%)',
      '--sunpillar-5': 'hsl(190, 60%, 40%)',
      '--sunpillar-6': 'hsl(200, 50%, 45%)',
  ...
  const shineStyle: React.CSSProperties = {
    ...
    backgroundImage: `
      ...
      repeating-linear-gradient(-45deg, #0a1a17 0%, hsl(170, 15%, 50%) 3.8%, hsl(170, 30%, 55%) 4.5%, hsl(170, 15%, 50%) 5.2%, #0a1a17 10%, #0a1a17 12%),
  ...
  const glareStyle: React.CSSProperties = {
    ...
    overflow: 'hidden',
    backgroundImage: `radial-gradient(farthest-corner circle at var(--pointer-x) var(--pointer-y), hsl(170, 30%, 70%) 12%, hsla(180, 30%, 25%, 0.8) 90%)`,
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            boxShadow: 'rgba(0, 0, 0, 0.8) calc((var(--pointer-from-left) * 10px) - 3px) calc((var(--pointer-from-top) * 20px) - 6px) 20px -5px, 0 0 40px rgba(45, 139, 122, 0.08)',
              ...
              {showUserInfo && (
                <div
                  ...
                  style={{
                    ...
                    left: 'var(--ui-inset)',
                    right: 'var(--ui-inset)',
                    background: 'rgba(10, 26, 23, 0.65)',
                    borderRadius: 'calc(max(0px, var(--card-radius) - var(--ui-inset) + var(--ui-radius-bias)))',
                    padding: '12px 14px',
                  } as React.CSSProperties}
                >
                  <div className="flex items-center gap-3">
                    <div className="rounded-full overflow-hidden border-2 border-accent/40 flex-shrink-0 w-11 h-11">
                      <img
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="text-sm font-semibold text-white/90 leading-none">@{handle}</div>
                      <div className="text-xs text-accent leading-none font-medium">{status}</div>
                    </div>
                  </div>
                  <button
                    className="border border-accent/40 bg-accent/10 hover:bg-accent hover:text-white rounded-xl px-4 py-2.5 text-xs font-bold text-accent cursor-pointer backdrop-blur-[10px] transition-all duration-300 ease-out hover:border-accent hover:-translate-y-px hover:shadow-[0_0_20px_rgba(45,139,122,0.3)]"
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: '2.5em' }}>
                <h3
                  ...
                  style={{
                    fontSize: 'min(5svh, 2.8em)',
                    backgroundImage: 'linear-gradient(to bottom, #fff, #3AA08C)',
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '14px',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #fff, #2D8B7A)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
